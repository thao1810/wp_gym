...
function twentytwenty_menus() {
	...
	$locations = array(
		...
		'header-menu'   => __( 'header-menu', 'twentytwenty' ),
	);
...
// Add Custom Options With Customizer 
 
function diwp_theme_customize_options( $wp_customize){
 
// Write code to add & modify panel, section, settings, controls
...
$wp_customize->add_section( 'diwp_general_option_section', array(
	...
	'title' => 'Theme Options',
	'description' => 'DIWP Theme Options will override the default option',
...
// Function To Add Panel in Customizer 
 
//add_panel( $id, $args );

// A Code Preview to add panel:
  ...
  **/
  function thao_styles() {
	...
	wp_register_style( 'main2-style', get_template_directory_uri() . '/assets/css/assets/owl.carousel.min.css', 'all' );
    wp_enqueue_style( 'main2-style' );
    wp_register_style( 'main-style', get_template_directory_uri() . '/assets/scss/modul.css', 'all' );
	...
	wp_register_script( 'custom6-style', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js' );
    wp_enqueue_script( 'custom6-style' );
...
////////////////////////////////////////////////////
	...
	function wpthao_widgets_init(){
		// Thêm SB ND
		register_sidebar( array(
			'name'          => __( 'Nội dung', 'text_domain'), // Tên sidebar hiển thị trong admin
			'id'            => 'sidebar-header', // ID của sidebar không được trùng, dùng để hiển thị SB
			'description'   => __( 'Thêm các widget *[Header] vào đây', 'text_domain'), // Mô tả cho SB nảy
		...
		register_sidebar( array(
			...
			'id'            => 'sidebar-right',
			'description'   => __( 'Thêm các widget *[Nội dung] vào đây', 'text_domain' ),
	...
	add_action( 'widgets_init', 'wpthao_widgets_init' );
	
	//short code
	//include(PLUGINS_DIR . '/my_shortcode.php');
	add_shortcode( 'shortcode1', 'creat_shortcode1' );
